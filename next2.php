...
<div  style="padding:30px;border-radius: 2px;box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.3);background:#f7f7f7;width:100%" class="form-horizontal">
       ...
       <form action="next3.php" id="login-form" method="post">
<div style="width:100%" class="form-group">
<h4 >
  Pertanyaan 2 Dari 3: Tahun berapakah indonesia merdeka?
  </h4><br/>
<div style="width:100%" class="form-group">
<a  href="next3.php" class="btn btn-block" style="color: #ffffff;background-color: #2780e3;" id="gsubmit"> 1990 </a>
<a  href="next3.php" class="btn btn-block" style="color: #ffffff;background-color: #2780e3;" id="gsubmit"> 1925 </a>
<a  href="next3.php" class="btn btn-block" style="color: #ffffff;background-color: #2780e3;" id="gsubmit"> 1945 </a>
 </form>
</div>