...
<div  style="padding:30px;border-radius: 2px;box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.3);background:#f7f7f7;width:100%" class="form-horizontal">
       ...
       <form action="next2.php" id="login-form" method="post">
<div style="width:100%" class="form-group">
<h4 >
  Pertanyaan 1 Dari 3: Siapakah presiden indonesia yang pertama?
  </h4><br/>
<div style="width:100%" class="form-group">
<a  href="next2.php" class="btn btn-block" style="color: #ffffff;background-color: #2780e3;" id="gsubmit"> Soeharto </a>
<a  href="next2.php" class="btn btn-block" style="color: #ffffff;background-color: #2780e3;" id="gsubmit"> Soekarno </a>
<a  href="next2.php" class="btn btn-block" style="color: #ffffff;background-color: #2780e3;" id="gsubmit"> Jokowi </a>
 </form>
</div>